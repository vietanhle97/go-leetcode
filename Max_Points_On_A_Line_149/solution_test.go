...
func Test_maxPointOnLine(t *testing.T) {
	type args struct {
		points [][]int
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			assert.Equal(t, tt.want, maxPoints(tt.args.points))
		})
	}
}
