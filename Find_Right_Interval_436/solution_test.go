...
func Test_findRightInterval(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			assert.Equal(t, tt.want, findRightInterval(tt.args.intervals))
		})
	}
}
